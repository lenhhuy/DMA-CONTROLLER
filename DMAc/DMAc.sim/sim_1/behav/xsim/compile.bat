...
REM
REM Generated by Vivado on Sat May 16 15:48:21 +0700 2026
...
echo "xvlog --incr --relax -prj tb_dma_fifo_vlog.prj"
call xvlog  --incr --relax -prj tb_dma_fifo_vlog.prj -log xvlog.log
