...
HD_PWD='D:/Semester 6/DA1/DMAc/DMAc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_top.tcl
