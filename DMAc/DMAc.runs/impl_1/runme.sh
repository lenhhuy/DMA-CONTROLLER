...
HD_PWD='D:/Semester 6/DA1/DMAc/DMAc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dma_top.tcl -notrace
