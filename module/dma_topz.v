...
module dma_top (
    ...
    input  wire [3:0]  dreq,            // DREQ từ 4 ngoại vi
    output wire [3:0]  dack,            // DACK tới 4 ngoại vi

    // ── Bus Master: HLD/HLDA (bus hệ thống) ──────────────────────────────────
    output wire        hld,             // Hold Request tổng (OR của 4 kênh)
